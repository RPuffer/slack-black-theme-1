...
ts-message .mention {
  background: #89ff6e !important;
  color: #ff1bec !important;
}
.btn {
  background: #06afcd;
  color: #fff;
...
#primary_file_button:hover {
  border: 2px solid #cd04da !important;
  background: #cd04da !important;
}
#primary_file_button {
  position: absolute;
  bottom: 1.375rem;
...
.p-channel_insights__message--truncate::before {
  background: linear-gradient(180deg, transparent, #282828 90%);
}
.c-button--outline {
  background: #2C2F33;
  color: white;
